...
sunt = loadImage("sun.png");
bakcground = loadImage("backgroundImg.png");
...
function setup(){
  ...
  sun.addImage("sun",sunt);
  sun.scale = 0.1;
  
 trex = createSprite(50,height-70,20,50);//crear sprite de Trex
